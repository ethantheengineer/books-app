...
public class DisplayQueryResultsController {
   ...
   private static final String DATABASE_URL = "jdbc:derby://localhost:1527/bookdb";
   private static final String USERNAME = "bookdb";
   private static final String PASSWORD = "bookdb";
